/**
 * Drawing a Reach cone constraint.
 *
 * This demo shows visually the meaning of each parameter of a Reach cone constraint.
 * 
 ...
 * Drag with the right and left button to translate and rotate the eye scene, respectively.
 */
