...
String[] example_paths = new String[]{
  "0005_2FeetJump001.bvh",
  "0005_JumpRope001.bvh",
  "0005_SideSkip001.bvh",
  "0007_Cartwheel001.bvh",
  "0008_ChaCha001.bvh",
  "0017_ParkourRoll001.bvh",
}; 
...
/*
 ...
 Preferred heuristic is TRIK_ECTIK.
*/
GHIK.HeuristicMode mode = GHIK.HeuristicMode.TRIK_ECTIK;
//---------------------------------------------------------------------------------------------------
