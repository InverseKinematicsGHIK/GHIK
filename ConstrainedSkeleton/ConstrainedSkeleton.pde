/*
Example of a constrained skeleton.
Drag with the right and left mouse buttons to translate and rotate the eye scene, respectively.
Move the red ball to solve the IK problem.
*/
